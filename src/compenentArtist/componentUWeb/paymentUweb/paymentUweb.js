...
import "./paymentUweb.css";
import ButtonContact from "../../contentArtist/ButtonContact";

export const PaymentUWeb = () => {
  return (
    <>
      <section className=" u-wrapper">
        <div className="container-payment-uweb-methods-all">
          <div className="container-payment-uweb-methods">
            <h2 className="main-uweb-profile">
              Tu perfil de Artista en este espacio?
            </h2>
            <div className="payment-uweb-price">
              <p>
            ...
            <div className="payment-uweb-methods">
              <p>PAGOS</p>
              <p>ARGENTINA</p>
              <p>
