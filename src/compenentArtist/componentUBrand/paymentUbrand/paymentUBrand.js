...
import "./paymentUbrand.css";

export const PaymentUBrand = () => {
  return (
    <>
      <section className=" u-wrapper">
        <div className="container-payment-ubrand-methods-all">
          <div className="container-payment-ubrand-methods">
            <h2 className="main-ubrand-profile">
              Tu perfil de Artista en este espacio?
            </h2>
            <div className="payment-ubrand-price">
              <p>
            ...
            <div className="payment-ubrand-methods">
              <p>PAGOS</p>
              <p>ARGENTINA</p>
              <p>
