...
export const MainArtist = () => {
  return (
    <section className="main-artist-container u-wrapper">
      ...
      <p className="main-text-artist-paragraph-2">
        En el grupo puedes compartir tus trabajos como “maestro” para mostrar lo
        que sabes, también puedes mostrar tus servicios en esa área. Junto a
        esto, moderaras ese grupo siguiendo el código del NinjArt compartir tu
        experiencia construirá un entorno educativo donde todos vamos a aportar
        y crecer juntos, a partir del arte. Cuando pases un periodo de 3 meses
        siendo el lider de un grupo, te solicitaremos detalles para crear tu
        perfil de Artista NinjArt. Es la tarjeta de presentación de tus
        habilidades en nuestra comunidad.
      </p>
    </section>
  );
};
